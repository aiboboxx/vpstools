...
async function regFreeok(page){
  ...
  console.log(usr);
  await page.goto('https://okgg.top/auth/register?code=wsOq', { timeout: 30000 })
  ...
  await page.goto('https://okgg.top/auth/login', { timeout: 30000 }).catch((err) => console.log('首页超时'));
  await sleep(3000);
...
async function main() {
  ...
  //await page.goto('https://okgg.top/auth/register?code=wsOq');
