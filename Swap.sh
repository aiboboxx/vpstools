...
count_file="$script_dir/counter.txt"
server_url="http://suntl.com/other/swap/counter.php"
...
increment_run_count() {
    ...
    count=$(echo $response | awk -F'"count":|}' '{print $2}')
...
show_menu(){
    ...
    echo -e "\033[36m -------------------------------------- \033[0m"
    echo -e "\n  请选择你需要的操作: \n"
    echo -e "\033[33m  1. 查看当前交换分区 \033[0m"
    echo -e "\033[33m  2. 设置新的交换分区 \033[0m"
